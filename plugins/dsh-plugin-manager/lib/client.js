...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const FALLBACK_REPO_PLUGINS = [
      { id: "dsh-plugin-manager", name: "dsh-plugin-manager", title: "插件管理", description: "DSH 插件管理与更新中心，支持自有插件更新/卸载/一键批量更新，浏览 2200+ 社区插件并一键安装。", author: "veildawn", category: "tools", version: "0.1.7", latestVersion: "0.1.7", downloadUrl: "https://github.com/veildawn/dsh-plugins/releases/download/dsh-plugin-manager@v0.1.7/dsh-plugin-manager-0.1.7.tgz", isRepoPlugin: true },
      ...
      { id: "dsh-market", name: "dsh-market", title: "插件市场（旧名）", description: "dsh-market 旧版插件市场，已由 dsh-plugin-manager 取代；仓库中保留的历史版本。", author: "veildawn", category: "tools", version: "0.1.7", latestVersion: "0.1.7", downloadUrl: "https://github.com/veildawn/dsh-plugins/releases/download/dsh-market@v0.1.7/dsh-market-0.1.7.tgz", isRepoPlugin: true },
    ];
