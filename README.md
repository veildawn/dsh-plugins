...
| 插件名称 | 目录 | 说明 | 最新独立版本 |
| :--- | :--- | :--- | :--- |
| **`dsh-market`** | [`plugins/dsh-market`](plugins/dsh-market) | 社区插件市场与本仓库更新管理器（可视化插件浏览、21 种分类筛选、一键安装/更新与实时日志） | [`v0.1.1`](https://github.com/veildawn/dsh-plugins/releases/tag/dsh-market@v0.1.1) |
...
./scripts/release.sh dsh-market 0.1.1
