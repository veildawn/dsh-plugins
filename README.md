...
| 插件名称 | 目录 | 说明 | 最新独立版本 |
| :--- | :--- | :--- | :--- |
| **`dsh-market`** | [`plugins/dsh-market`](plugins/dsh-market) | 插件市场与自有插件更新/卸载管理器（自有插件一键批量更新(N)、社区21分类、静默直接复制指令、异步平滑重启与自动恢复） | [`v0.1.5`](https://github.com/veildawn/dsh-plugins/releases/tag/dsh-market@v0.1.5) |
...
./scripts/release.sh dsh-market 0.1.5
