...
| 插件名称 | 目录 | 说明 | 最新独立版本 |
| :--- | :--- | :--- | :--- |
| **`dsh-model-roles`** | [`plugins/dsh-model-roles`](plugins/dsh-model-roles) | 通过「智选模式」按需启用模型角色路由、自动分工、识图子代理、计划模式与顾问复核 | [`v0.5.0`](https://github.com/veildawn/dsh-plugins/releases/tag/dsh-model-roles@v0.5.0) |
...
dsh plugin add --profile web https://github.com/veildawn/dsh-plugins/releases/download/dsh-model-roles@v0.5.0/dsh-model-roles-0.5.0.tgz
...
./scripts/release.sh dsh-model-roles 0.5.0
