...
| **`dsh-ai-proxy`** | [`plugins/dsh-ai-proxy`](plugins/dsh-ai-proxy) | AI Proxy Service 网关对接与 LLM Provider 插件（支持 Chat/completions、Anthropic messages、Responses 多格式智能匹配、最高推理强度开关、OAuth 2.0 PKCE 认证、Token 刷新与阶梯推理） | [`v0.2.10`](https://github.com/veildawn/dsh-plugins/releases/tag/dsh-ai-proxy@v0.2.10) |
...
# 3. 安装 AI Proxy 网关插件
dsh plugin add --profile web https://github.com/veildawn/dsh-plugins/releases/download/dsh-ai-proxy@v0.2.10/dsh-ai-proxy-0.2.10.tgz
